...
`}(e);q.filmModal.insertAdjacentHTML("beforeend",a)}(B);let n={closeBtn:document.querySelector("[button-modal-close]"),addQueueBtn:document.querySelector("[button-add-queue]"),addWatchBtn:document.querySelector("[button-add-watch]"),unselectBtn:document.querySelector("[button-unselect]")};P(n.unselectBtn),n.closeBtn.addEventListener("click",R),n.addQueueBtn.addEventListener("click",O),n.addWatchBtn.addEventListener("click",W),n.unselectBtn.addEventListener("click",G);let o=$("watched")||[],c=$("queue")||[],u=o.some(e=>e.id===B.id);c.some(e=>e.id===B.id)&&k(n.addQueueBtn),u&&k(n.addWatchBtn),q.filmModal.classList.remove("is-hidden"),a=window.innerWidth-q.body.offsetWidth+"px",q.body.classList.add("disable-scroll"),q.body.style.paddingRight=a,window.addEventListener("keydown",x)}function R(){q.filmModal.classList.add("is-hidden"),window.removeEventListener("keydown",x),q.body.classList.remove("disable-scroll"),q.body.style.paddingRight=0,(0,r.updateMoviesGalleryByStatus)("watched",globalCurrentPage)}function x(e){"Escape"===e.code&&R()}function G(){let e=$("watched")||[],t=$("queue")||[],a=e.some(e=>e.id===B.id);t.some(e=>e.id===B.id)&&(0,u.removeSaveQueue)(B),a&&(0,u.removeSaveWatch)(B),P(document.querySelector("[button-add-watch]")),P(document.querySelector("[button-add-queue]"))}function O({target:e}){(0,u.dataSaveQueue)(B),window.location.pathname.includes("my-library")&&(document.querySelector(".watched-btn").classList.contains("active")?(0,r.updateMoviesGalleryByStatus)("watched",globalCurrentPage):(0,r.updateMoviesGalleryByStatus)("queue",globalCurrentPage)),(0,r.updateMoviesGalleryByStatus)("watch"),k(e),P(document.querySelector("[button-add-watch]")),P(document.querySelector("[button-unselect]"))}function W({target:e}){(0,u.dataSaveWatch)(B),window.location.pathname.includes("my-library")&&(document.querySelector(".watched-btn").classList.contains("active")?(0,r.updateMoviesGalleryByStatus)("watched",globalCurrentPage):(0,r.updateMoviesGalleryByStatus)("queue",globalCurrentPage)),(0,r.updateMoviesGalleryByStatus)("watch"),k(e),P(document.querySelector("[button-add-queue]")),P(document.querySelector("[button-unselect]"))}function $(e){return function(e){let t;try{t=JSON.parse(e)}catch(e){console.log("ERROR: ",e.message),console.log("ERROR CODE: ",e.code)}return t}(localStorage.getItem(e))}function k(e){e.disabled=!0,e.classList.add("is-disabled")}function P(e){e.disabled=!1,e.classList.remove("is-disabled")}q.galleryWatchBox.addEventListener("click",E),q.filmModal.addEventListener("click",function(e){e.currentTarget===e.target&&R()}),window.loadNoPoster=function(e){e.src=t(c)};var r=n("lubd3");let C={galleryMyLibraryWatch:document.querySelector(".gallery_watch-block"),galleryMyLibraryQueue:document.querySelector(".gallery_queue-block"),watchedBtn:document.querySelector(".watched-btn"),queueBtn:document.querySelector(".queue-btn"),unselectBtn:document.querySelector(".unselect-btn"),paginationMyLibraryContainer:document.querySelector(".pagination-mylibrary_container"),filmModal:document.querySelector("[data-modal]")};C.galleryMyLibraryWatch.classList.remove("is-hidden"),C.galleryMyLibraryQueue.classList.add("is-hidden"),C.watchedBtn.classList.add("active"),C.queueBtn.classList.remove("active"),(0,r.updateMoviesGalleryByStatus)("watched"),C.watchedBtn.addEventListener("click",function({target:e}){C.galleryMyLibraryWatch.classList.remove("is-hidden"),C.galleryMyLibraryQueue.classList.add("is-hidden"),e.classList.contains("active")||(C.watchedBtn.classList.add("active"),C.queueBtn.classList.remove("active"),(0,r.updateMoviesGalleryByStatus)(e.dataset.status))}),C.queueBtn.addEventListener("click",function({target:e}){C.galleryMyLibraryWatch.classList.add("is-hidden"),C.galleryMyLibraryQueue.classList.remove("is-hidden"),e.classList.contains("active")||(C.watchedBtn.classList.remove("active"),C.queueBtn.classList.add("active"),(0,r.updateMoviesGalleryByStatus)(e.dataset.status))})}();
//# sourceMappingURL=mylibrary.655631ef.js.map
